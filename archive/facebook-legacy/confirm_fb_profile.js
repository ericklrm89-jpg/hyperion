...
async function main() {
  ...
  await call('Runtime.evaluate', { expression: "window.location.href='https://www.facebook.com/fairdrawapp/';" });
  await new Promise(r => setTimeout(r, 6000));

  const ss = await call('Page.captureScreenshot', { format: 'png' });
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\fb_FINAL_PROFILE_CONFIRM.png', Buffer.from(ss.data, 'base64'));
  console.log('Saved fb_FINAL_PROFILE_CONFIRM.png');
  ws.close();
}
