...
http.get('http://127.0.0.1:9222/json', r => {
  let d = ''; r.on('data', c => d += c); r.on('end', () => {
    ...
    ws.on('open', async () => {
      ...
      console.log('🖱️ Clic en botón "Upload" del sidebar via DOM...');
      ...
      fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\tiktok_upload_clicked.png', Buffer.from(ss.data, 'base64'));
