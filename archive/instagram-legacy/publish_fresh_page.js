...
async function main() {
  ...
  console.log('Clicking close modal button (614, 190)...');
  await mouseClick(ws, 614, 190);
  await wait(2000);

  // Click Descartar if dialog appears
  ...
  console.log('Navigating fresh to feed...');
  ...
  console.log('Injecting file into fresh modal input...');
  ...
  // Caption
  console.log('Injecting Spanish caption...');
  await cdpCall(ws, 'Runtime.evaluate', {
    expression: `(() => {
  ...
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\ig_fresh_page_published.png', Buffer.from(ss.data, 'base64'));
  console.log('📸 Screenshot saved: ig_fresh_page_published.png');
