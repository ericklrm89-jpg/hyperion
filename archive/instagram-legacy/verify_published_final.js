...
async function main() {
  ...
  console.log('Waiting 10s for Instagram Reel publish completion checkmark...');
  await new Promise(r => setTimeout(r, 10000));

  const ss = await cdpCall('Page.captureScreenshot', { format: 'png' });
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\ig_reel_spanish_published_confirmed.png', Buffer.from(ss.data, 'base64'));
  console.log('📸 Screenshot saved: ig_reel_spanish_published_confirmed.png');
