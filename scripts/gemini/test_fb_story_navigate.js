...
http.get('http://localhost:9222/json', r => {
  ...
  r.on('end', async () => {
    ...
    // Navegar a Stories Create
    console.log('Navigating to stories/create...');
    await cdpCall(ws, 'Page.navigate', { url: 'https://www.facebook.com/stories/create' });

    // Esperar carga e hidratación
    ...
    fs.writeFileSync('fb_stories_create.png', Buffer.from(ss.data, 'base64'));
    console.log('Screenshot saved to fb_stories_create.png');
