...
async function main() {
  ...
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\gemini_current.png', Buffer.from(ss.data, 'base64'));
  console.log('📸 Captura de Gemini guardada: gemini_current.png');
