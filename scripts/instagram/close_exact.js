...
async function main() {
  ...
  console.log('Clicking inner modal close X at 873, 109...');
  await mouseClick(873, 109);
  await new Promise(r => setTimeout(r, 1500));

  console.log('Clicking outer modal close X at 1259, 27...');
  await mouseClick(1259, 27);
  await new Promise(r => setTimeout(r, 1500));
  ...
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\ig_closed_exact.png', Buffer.from(ss.data, 'base64'));
  console.log('📸 Screenshot saved: ig_closed_exact.png');
