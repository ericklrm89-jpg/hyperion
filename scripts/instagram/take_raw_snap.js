...
async function main() {
  ...
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\ig_raw_state.png', Buffer.from(ss.data, 'base64'));
  console.log('📸 Captura de estado guardada: ig_raw_state.png');
