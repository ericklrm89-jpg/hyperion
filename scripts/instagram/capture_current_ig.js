...
async function main() {
  ...
  // Inyectar Manus para ver el estado visual con números
  ...
  fs.writeFileSync('C:\\Users\\erick\\.gemini\\antigravity-ide\\scratch\\hyperion-web-agent\\instagram_current.png', Buffer.from(ss.data, 'base64'));
  console.log('✅ Captura de control guardada en instagram_current.png');
  ws.close();
}
main();
