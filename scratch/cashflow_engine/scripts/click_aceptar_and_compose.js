...
async function run() {
  console.log('⚡ Iniciando proceso de ejecución con Capa Manus activa...');
  ...
  ws.on('open', async () => {
    ...
    // 2. Hacer clic en el botón [1] Aceptar para cerrar el popup de error
    console.log('2. Haciendo clic en [1] Aceptar...');
    ...
    // 3. Maximizar ventana de compose si está minimizada
    console.log('3. Maximizando ventana de redacción...');
    ...
    // 4. Enfocar y escribir el destinatario con teclado nativo
    console.log('4. Escribiendo destinatario (Para)...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 5. Escribir Asunto
    console.log('5. Escribiendo Asunto...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 6. Inyectar cuerpo HTML
    console.log('6. Inyectando cuerpo HTML enriquecido...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    if (fs.existsSync(FLYER)) {
      console.log(`7. Inyectando archivo adjunto HD: ${FLYER}...`);
    ...
    // 8. Capturar vista previa
    console.log('8. Capturando vista previa con Capa Manus...');
    ...
    // 9. Enviar
    console.log('9. Haciendo clic en Enviar...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 10. Navegar a Enviados
    console.log('10. Navegando a Enviados (#sent)...');
