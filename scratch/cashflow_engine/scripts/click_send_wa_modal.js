...
async function run() {
  ...
  ws.on('open', async () => {
    ...
    console.log('1. Clic exacto en botón verde Enviar...');
    // Clic físico vía coordenadas o elementFromPoint en la esquina inferior derecha del modal
    ...
    // Si aún está visible el modal, enviar Enter
    ...
    if (snap && snap.result && snap.result.data) {
      ...
      console.log('✅ CAPTURA FINAL WHATSAPP ACTUALIZADA:', out);
    }
