...
async function run() {
  console.log('⚡ [Hyperion 3.5] Iniciando protocolo de limpieza y envío limpio...');
  ...
  ws.on('open', async () => {
    ...
    // 2. Cerrar el popup de alerta "Aceptar"
    console.log('2. Cerrando modal de alerta con clic en Aceptar...');
    ...
    // 3. Cerrar borradores abiertos previos
    console.log('3. Cerrando borradores previos residuales...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 4. Hacer clic en Redactar para abrir UN borrador nuevo limpio
    console.log('4. Haciendo clic en Redactar (Borrador Nuevo Limpio)...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 5. Escribir Destinatario en el borrador activo
    console.log('5. Escribiendo Destinatario (erickl.rm@gmail.com)...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 6. Escribir Asunto
    console.log('6. Escribiendo Asunto...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    await new Promise(r => setTimeout(r, 300));
    await call('Input.insertText', { text: EMAIL_DATA.subject });
    await new Promise(r => setTimeout(r, 600));

    // 7. Inyectar HTML real en el cuerpo
    console.log('7. Inyectando cuerpo HTML visual con tabla financiera y oferta Hormozi...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    if (fs.existsSync(FLYER)) {
      console.log(`8. Inyectando archivo adjunto HD: ${FLYER}...`);
    ...
    // 9. Capturar vista previa
    console.log('9. Capturando vista previa HD del correo...');
    ...
    // 10. Enviar correo
    console.log('10. Haciendo clic en Enviar...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    // 11. Navegar a Enviados
    console.log('11. Navegando a Enviados (#sent)...');
