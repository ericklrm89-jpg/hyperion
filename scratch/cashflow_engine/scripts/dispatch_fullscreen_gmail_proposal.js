...
const EMAIL_DATA = {
  ...
  body_html: `
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #0f172a; max-width: 680px; line-height: 1.6; border: 1px solid #cbd5e1; border-radius: 16px; padding: 28px; background: #ffffff; margin: 0 auto; box-shadow: 0 12px 30px -8px rgba(0,0,0,0.1);">
  
  <!-- Header Branding -->
  <table style="width: 100%; border-bottom: 2px solid #0f172a; padding-bottom: 14px; margin-bottom: 22px;">
    <tr>
      <td style="vertical-align: middle;">
        <span style="font-size: 24px; font-weight: 900; color: #0f172a; letter-spacing: -0.5px;">⚡ NanoAI</span>
        <span style="background: #2563eb; color: #ffffff; font-size: 11px; font-weight: 800; padding: 4px 9px; border-radius: 6px; margin-left: 8px; text-transform: uppercase; letter-spacing: 0.5px;">Industrial OS</span>
      </td>
      <td style="text-align: right; vertical-align: middle;">
        <span style="background: #ecfdf5; color: #059669; font-size: 11px; font-weight: 800; padding: 5px 14px; border-radius: 20px; border: 1px solid #a7f3d0; text-transform: uppercase;">
  ...
  <!-- Direct Pain Hook -->
  <h2 style="font-size: 18px; font-weight: 900; color: #0f172a; margin-top: 0; margin-bottom: 12px; line-height: 1.35;">
    ¿Cuánto capital pierde su planta al mes dependiendo de cálculo manual para cotizar, despiezar planos y estimar mermas?
  </h2>
  
  <p style="font-size: 14px; color: #334155; margin-bottom: 18px; line-height: 1.65;">
  ...
  <div style="background: #0f172a; border-radius: 14px; padding: 20px; color: #ffffff; margin-bottom: 24px; border: 1px solid #1e293b; box-shadow: 0 4px 15px rgba(15,23,42,0.15);">
    <div style="font-size: 11.5px; text-transform: uppercase; letter-spacing: 1px; color: #94a3b8; font-weight: 800; margin-bottom: 14px; text-align: center;">
      📉 COMPARATIVA FINANCIERA: PERSONAL MANUAL VS. NANOAI INDUSTRIAL OS
    </div>
    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
      <thead>
        <tr style="border-bottom: 2px solid #334155;">
          <th style="text-align: left; padding: 8px 0; color: #94a3b8;">Concepto Operativo</th>
          <th style="text-align: center; padding: 8px 0; color: #f87171;">Personal Manual (3 Personas)</th>
          <th style="text-align: right; padding: 8px 0; color: #34d399;">Con NanoAI On-Premise</th>
        </tr>
      </thead>
      <tbody>
        <tr style="border-bottom: 1px solid #1e293b;">
          <td style="padding: 10px 0; color: #cbd5e1;">Nómina fija (Sueldos + IESS):</td>
          <td style="padding: 10px 0; text-align: center; color: #f87171; font-weight: 700;">-$3,600 USD / mes</td>
          <td style="padding: 10px 0; text-align: right; color: #34d399; font-weight: 800;">$0 nómina recurrente</td>
        </tr>
        <tr style="border-bottom: 1px solid #1e293b;">
          <td style="padding: 10px 0; color: #cbd5e1;">Tiempo de Cotización:</td>
          <td style="padding: 10px 0; text-align: center; color: #fca5a5;">24 a 48 horas</td>
          <td style="padding: 10px 0; text-align: right; color: #60a5fa; font-weight: 800;">< 45 segundos en vivo</td>
        </tr>
        <tr style="border-bottom: 1px solid #1e293b;">
          <td style="padding: 10px 0; color: #cbd5e1;">Merma y Fuga de Material:</td>
          <td style="padding: 10px 0; text-align: center; color: #fca5a5;">8% a 15% del costo</td>
          <td style="padding: 10px 0; text-align: right; color: #34d399; font-weight: 800;">< 2% (Nesting algorítmico)</td>
        </tr>
        <tr>
          <td style="padding: 12px 0 0 0; color: #f8fafc; font-weight: 800;">Recuperación Neta en Caja:</td>
          <td style="padding: 12px 0 0 0; text-align: center; color: #ef4444; font-weight: 900;">Pérdida continua</td>
          <td style="padding: 12px 0 0 0; text-align: right; color: #10b981; font-weight: 900; font-size: 15px;">+$4,200 USD / mes</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <!-- Hormozi $100M Offer -->
  <div style="background: #eff6ff; border: 2px solid #3b82f6; border-radius: 12px; padding: 18px; margin-bottom: 24px;">
    <div style="font-size: 14px; font-weight: 900; color: #1e40af; margin-bottom: 4px;">
  ...
  <div style="text-align: center; margin-bottom: 22px;">
    <a href="https://wa.me/593998098229?text=Hola%20Erick,%20deseo%20coordinar%20la%20visita%20tecnica%20de%20NanoAI" style="display: inline-block; background: #0f172a; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 10px; font-weight: 800; font-size: 14px; border: 2px solid #2563eb; box-shadow: 0 8px 18px rgba(15,23,42,0.25);">
...
async function run() {
  ...
  ws.on('open', async () => {
    ...
    console.log('1. Navegando a vista de Redacción Completa (Full Screen Compose)...');
    const composeUrl = `https://mail.google.com/mail/u/0/?view=cm&fs=1&to=${encodeURIComponent(EMAIL_DATA.to)}&su=${encodeURIComponent(EMAIL_DATA.subject)}`;
    await call('Page.navigate', { url: composeUrl });
    ...
    console.log('3. Inyectando plantilla HTML enriquecida dentro del editor oficial...');
    ...
    if (fs.existsSync(FLYER)) {
      console.log(`4. Inyectando archivo adjunto HD: ${FLYER}...`);
    ...
    console.log('5. Capturando vista previa HD del correo renderizado...');
    const preSnap = await call('Page.captureScreenshot', { format: 'jpeg', quality: 95 });
    if (preSnap && preSnap.data) {
      const outPre = path.join(ASSETS_DIR, 'live_gm_fullscreen_proposal.jpg');
      fs.writeFileSync(outPre, Buffer.from(preSnap.data, 'base64'));
      console.log('📸 Captura Full Screen guardada:', outPre);
    }

    console.log('6. Enviando correo...');
    await call('Runtime.evaluate', {
      expression: `(() => {
    ...
    console.log('7. Navegando a Enviados (#sent)...');
    ...
    if (postSnap && postSnap.data) {
      const outPost = path.join(ASSETS_DIR, 'live_gm_sent_fullscreen_verified.jpg');
